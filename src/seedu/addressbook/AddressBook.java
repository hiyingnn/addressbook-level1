...
public class AddressBook {
    ...
    /**
     * Sorts persons in address book in alphabetical order.
     */
    private static String executeSortAddressBook() {
        ...
        ArrayList<HashMap<PersonProperty, String>> toBeDisplayed = (ArrayList<HashMap<PersonProperty, String>>) toBeSorted.stream().sorted((p1, p2) -> p1.get(PersonProperty.NAME).compareToIgnoreCase(p2.get(PersonProperty.NAME))).collect(Collectors.toList());
        ALL_PERSONS.clear();
        ALL_PERSONS.addAll(toBeDisplayed);
        showToUser(toBeDisplayed);
